...
namespace pricelist_manager.Server.Migrations
{
    ...
    [Migration("20250718083757_AddUserIDtoProductInstance")]
    partial class AddUserIDtoProductInstance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.CompanyLogger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.PricelistLogger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.UpdateListLogger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.UserLogger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.ProductInstance", b =>
                {
                    ...
                    b.HasOne("pricelist_manager.Server.Models.User", "UpdatedBy")
                        .WithMany("UpdatedProductInstances")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("pricelist_manager.Server.Models.User", b =>
                {
                    b.Navigation("UpdatedProductInstances");
                });
